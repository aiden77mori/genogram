...
function initDiagram() { 
  ...
  const diagram =
    $(go.Diagram,
      ...
      var slash = go.Geometry.parse("F M38 0 L40 0 40 2 2 40 0 40 0 38z" + "F M40 38 L40 40 38 40 0 2 0 0 2 0z");
      var plus = go.Geometry.parse("F M18 2 L20 0 22 2 22 38 20 40 18 38z" + "F M2 22 L0 20 2 18 38 18 40 20 38 22z");
      ...
      diagram.nodeTemplateMap.add("N",  // Miscarriage
      $(go.Node, "Vertical",
        { locationSpot: go.Spot.Center, locationObjectName: "ICON", selectionObjectName: "ICON" },
        $(go.Panel,
          { name: "ICON" },
